...
from utils.general import collate_fn, get_train_transform, get_valid_transform
...
def create_train_dataset(img_dir, annot_dir, classes, WIDTH=2688,HEIGHT=1520):
...
def create_valid_dataset(img_dir, annot_dir, classes, WIDTH=2688,HEIGHT=1520):
...
if __name__ == '__main__':
    from config import (
        CLASSES, WIDTH,HEIGHT, TRAIN_IMG, TRAIN_ANNOT
    )   
